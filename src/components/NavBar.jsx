...
const Navbar = () => {
  ...
  return (
  <>
    <nav className="bg-gray-800 sticky w-full top-0 z-20">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex space-x-4 uppercase">
          <Link 
            ...
            "text-1xl text-gray-500 hover:text-black hover:bg-opacity-80 hover:bg-yellow-400 h-16 px-2 font-bold flex items-center" }>Top Rated</Link>
          <Link 
            to="NowPlay" 
            ...
            "text-1xl text-gray-500 hover:text-black hover:bg-opacity-80 hover:bg-yellow-400 h-16 px-2 font-bold flex items-center" }>Now Play</Link>
          <Link 
            to="Popular" 
            ...
            "text-1xl text-gray-500 hover:text-black hover:bg-opacity-80 hover:bg-yellow-400 h-16 px-2 font-bold flex items-center" }>Popular</Link>
          <Link 
            to="Upcoming"
            ...
            "text-1xl text-gray-500 hover:text-black hover:bg-opacity-80 hover:bg-yellow-400 h-16 px-2 font-bold flex items-center" }>Upcoming</Link>
        </div>
        <Link to="/">
